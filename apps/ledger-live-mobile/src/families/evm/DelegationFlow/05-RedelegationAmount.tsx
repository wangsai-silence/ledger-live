...
type Props = StackNavigatorProps<EvmDelegationFlowParamList, ScreenName.EvmRedelegationAmount>;

export default function RedelegationAmount({ navigation, route }: Props) {
