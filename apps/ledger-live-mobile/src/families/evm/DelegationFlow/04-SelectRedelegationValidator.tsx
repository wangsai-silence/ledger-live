...
type Props = StackNavigatorProps<EvmDelegationFlowParamList, ScreenName.EvmRedelegationValidator>;

export default function SelectRedelegationValidator({ navigation, route }: Props) {
  ...
  return (
    <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.alertContainer}>
        <Alert
          type="info"
          title={t("delegation.infoWording.evm.redelegate", {
